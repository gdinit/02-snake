...
// WINDOW
// constexpr unsigned short int	CONFIG_WIN_WIDTH = { 1600 }, CONFIG_WIN_HEIGHT =
// { 1200 };
// constexpr unsigned short int	CONFIG_WIN_WIDTH = { 1024 }, CONFIG_WIN_HEIGHT =
// { 768 };
// constexpr unsigned short int	CONFIG_WIN_WIDTH = { 768 }, CONFIG_WIN_HEIGHT =
// { 576 };
// constexpr unsigned short int	CONFIG_WIN_WIDTH = { 700 }, CONFIG_WIN_HEIGHT =
// { 550 };
...
constexpr signed short int	CONFIG_LASTCELL =
{ CONFIG_ROWS* CONFIG_COLUMNS };
// SNAKE
...
constexpr float
				CONFIG_PREGAME_ANIMATION_POS_X {
	CONFIG_WIN_WIDTH / 2
};
constexpr float
				CONFIG_PREGAME_ANIMATION_POS_Y {
	CONFIG_WIN_HEIGHT* 0.38f
};
// SCORE
...
// FRUIT
constexpr float
				CONFIG_NEW_FRUIT_MIN_DISTANCE_TO_HEAD {
	CONFIG_WIN_WIDTH / 3
};
// GAME SPEED
